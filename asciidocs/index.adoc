...
Für die Geräte in der HTL Leonding gibt es derzeit keine einheitliche Anwendung mithilfe derer sie dargestellt und verwaltet werden.
...
* Anwendung soll bis Ende des Schuljahres fertig gestellt werden