...
Für die Geräte in der HTL Leonding gibt es derzeit keine einheitliche Anwendung mithilfe derer sie dargestellt und verwaltet werden können.
...
Ziel ist eine funktionierende, benutzeroberflächliche Anwendung mit der einfach und unkompliziert alle Geräte eines Gebäudes verwaltet werden können und Geräte hinzugefügt sowie entfernt werden können.
...
* Anwendung soll bis Ende des Schuljahres fertiggestellt werden
